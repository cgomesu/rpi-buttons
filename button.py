...
ap.add_argument("--log-file", type=str, default="button.log", help="string: /path/to/button.log")
ap.add_argument("--red-command", type=str, default="red-button.sh", help="string: /path/to/red-button.sh RED button press script")
ap.add_argument("--white-command", type=str, default="white-button.sh", help="string: /path/to/white-button.sh RED button press script")
ap.add_argument("--yellow-command", type=str, default="yellow-button.sh", help="string: /path/to/yellow-button.sh RED button press script")
